 ...
 * every minute that they've gone over, and then a 15% tax on the subtotal.Need to create separate methods to calculate 
 * the tax, to calculate the overage fees, and to calculate and print the final total.Please print this as an itemized bill.
 * 
 * 
 */
